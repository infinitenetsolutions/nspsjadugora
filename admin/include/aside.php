 ...
 <!-- Main Sidebar Container -->
  <aside class="main-sidebar sidebar-light-primary elevation-4" style="">
      ...
      <div class="sidebar">
          ...
          <div class="user-panel mt-3 pb-3 mb-3 d-flex" style="background-color: #fff !important;">
              <div class="image">
                  <center><img src="images/logo.png" class="" alt="User Image" style="width: 102% !important;"></center>
              </div>
          </div>
...
<!--                              <span class="badge badge-danger right">2</span>-->
                  ...
                  <!-- <li class="nav-item has-treeview" <?php //echo authorityCheck(9); ?>>
				   ...
				   <li class="nav-item has-treeview" <?php echo authorityCheck(10); ?>>
                      <a href="admission" class="nav-link text-black <?php if($page_no == "10"){ echo 'active'; } ?>">
                          <i class="nav-icon fas fa-address-card"></i>
                          <p>
                              Admission
                          </p>
                  ...
                  <li class="nav-item has-treeview" <?php echo authorityCheck(11); ?>>
                      <a href="about?change-email" class="nav-link text-black <?php if($page_no == "11"){ echo 'active'; } ?>">
